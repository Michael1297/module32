...
constexpr Company::Company(
  ...
  , activities_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , year_(0)
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, activities_),
  PROTOBUF_FIELD_OFFSET(::Company, foreign_economic_activities_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ities\030\004 \001(\t\022#\n\033foreign_economic_activiti"
  "es\030\005 \001(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_company_2eproto = {
  false, false, 128, descriptor_table_protodef_company_2eproto, "company.proto", 
...
class Company::_Internal {
 public:
  ...
  static void set_has_foreign_economic_activities(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  activities_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_activities()) {
    activities_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_activities(), 
      GetArenaForAllocation());
  }
  ::memcpy(&year_, &from.year_,
    static_cast<size_t>(reinterpret_cast<char*>(&foreign_economic_activities_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreign_economic_activities_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&foreign_economic_activities_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreign_economic_activities_));
}
...
inline void Company::SharedDtor() {
  ...
  activities_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      activities_.ClearNonDefaultToEmpty();
    }
  }
  if (cached_has_bits & 0x00000018u) {
    ::memset(&year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&foreign_economic_activities_) -
        reinterpret_cast<char*>(&year_)) + sizeof(foreign_economic_activities_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          auto str = _internal_mutable_activities();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Company.activities");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          _Internal::set_has_foreign_economic_activities(&has_bits);
          foreign_economic_activities_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      this->_internal_activities().data(), static_cast<int>(this->_internal_activities().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "Company.activities");
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_activities(), target);
  }

  // optional bool foreign_economic_activities = 5;
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_foreign_economic_activities(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Company)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _internal_set_activities(from._internal_activities());
    }
    if (cached_has_bits & 0x00000008u) {
      year_ = from.year_;
    }
    if (cached_has_bits & 0x00000010u) {
      foreign_economic_activities_ = from.foreign_economic_activities_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &activities_, lhs_arena,
      &other->activities_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, foreign_economic_activities_)
      + sizeof(Company::foreign_economic_activities_)
      - PROTOBUF_FIELD_OFFSET(Company, year_)>(
